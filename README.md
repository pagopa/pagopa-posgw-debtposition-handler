...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=pagopa_pagopa-posgw-debtposition-handler&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=pagopa_pagopa-posgw-debtposition-handler)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=pagopa_pagopa-posgw-debtposition-handler&metric=coverage)](https://sonarcloud.io/summary/new_code?id=pagopa_pagopa-posgw-debtposition-handler)
...
```sh
docker compose up --scale pagopa-posgw-debtposition-handler=0
```
